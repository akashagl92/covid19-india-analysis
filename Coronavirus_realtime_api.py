...
tab2 = Panel(child=q, title="All Deaths - Statewise")
...
tab3 = Panel(child=s, title="Cases-to-Death Ratio over Time - Statewise" )
...
#citation = Label(x=-200, y=550, x_units='screen', y_units='screen',
#                 text="Last Updated : {}".format(latest_date), render_mode='css', text_font_size='12px')
#t.add_layout(citation, 'right')
...
div = Div(text="""* States with Data Corrected implied through negative growth on a particular date on the timescale""",
width=50, height=100, align='end')
layout = column(w, div, sizing_mode="scale_width")
...
x.yaxis.axis_label = 'Death Growth Rate'
...
div = Div(text="""* States with Data Corrected implied through negative growth on a particular date on the timescale""",
width=50, height=100, align='end')
layout = column(x, div, sizing_mode="scale_width")

tab8 = Panel(child=layout, title="Death Growth Rate - Statewise")
